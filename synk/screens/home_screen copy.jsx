...
import { StyleSheet, View, Text, Button, FlatList, TouchableOpacity, Alert, ActivityIndicator } from 'react-native';
...
export default function HomeScreen({ navigation }) {
    ...
    const handleCompetitionPress = (competition) => {
        if (competition.status === 'open') {
            ...
            navigation.navigate('WinnersScreen', {
                highlightSubmissionId: competition.winner,
            });
        }
    };
